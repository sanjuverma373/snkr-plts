...
import footerimg from '../assets/images/ft-logo-img.png'
import { Col, Container, Row } from 'react-bootstrap'

const Footersec = () => {
        return (
                <div className="pt-md-4 mt-3 pt-3 bg-blk" id="FORUM">
                        <Container className=" position-relative ">
                                <img src={footerimg} alt="#" />
                                <Row>
                                        <Col lg={4} md={12}>
                                                <p className="fs-x-sm fw-normal text-white-grey lh-185 ff-poppins">Sed nec ultricies felis, vitae
                                                        facilisis ipsum.
                                                        Morbi
                                                        id turpis euismod, rhoncus tortor quis,
                                                        lobortis sapien. Sed imperdiet nulla in leo ullamcorper, in finibus elit porta. </p>
                                                <div className="d-flex align-items-center pt-4 pb-2 gap-2">
                                                        <a className="ft-icon" href="https://www.facebook.com/" target="_blank"><svg width="35" height="35"
                                                        ...
                                                        <a className="ft-icon px-3" href="https://twitter.com/" target="_blank"><svg width="36" height="35"
                                                        ...
                                                        <a className="ft-icon" href="https://www.google.com/" target="_blank"><svg width="36" height="35"
                                                                viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                        ...
                                        <Col lg={8} md={12} className=" pb-5">
                                                <Row>
                                                        <Col lg={3} md={6} className="col-6">
                                                                <ul>
                                                                        <li className="mb-4 "><a className="text-whites fs-s-md fw-semibold lh-150 ff-poppins"
                                                                                href="">CUSTOM
                                                                                LINKS</a>
                                                                        </li>
                                                                        <li className="mb-3 "><a className="fs-s-md fw-normal text-white-grey1 lh-150 ff-poppins footer-h"
                                                                                href="">Lorem
                                                                                ipsum</a>
                                                                        </li>
                                                                        <li><a className="fs-s-md fw-normal text-white-grey1 lh-150 ff-poppins footer-h" href="">Lorem
                                                                                ipsum</a></li>
                                                                </ul>
                                                        </Col>
                                                        <Col lg={3} md={6} className="col-6">
                                                                <ul>
                                                                        ...
                                                                        <li><a className="fs-s-md fw-normal text-white-grey1 lh-150 ff-poppins footer-h" href="">Lorem
                                                                                ipsum</a></li>
                                                                        <li className="my-3 "><a className="fs-s-md fw-normal text-white-grey1 lh-150 ff-poppins footer-h"
                                                                                href="">Lorem
                                                                                ipsum</a>
                                                                        </li>
                                                                        <li><a className="fs-s-md fw-normal text-white-grey1 lh-150 ff-poppins footer-h" href="">Lorem
                        ...
                        <div className="ft-crd py-4">
                                <p className="text-center fw-normal fs-s-md text-white-grey1 lh-150 ff-poppins ">© Copyright SNKRPLTS 2021. </p>
                        </div>
